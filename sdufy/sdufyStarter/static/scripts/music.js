...
function loadTrackList() {
    ...
    let newTrack = {
        name: sessionStorage.getItem('musictitle'),
        artist: sessionStorage.getItem('musicartist'),
        // image : (image[i].src).toString().replace('http://localhost:8000', ''),,
        image: sessionStorage.getItem('musicimage'),
        path: sessionStorage.getItem('musicpath'),
    }
    track_list.push(newTrack)
    playTrack()
}
...
function playCurrentMusic(musicPath, musicTitle, musicArtist, musicCover) {
    sessionStorage.setItem('musicpath', musicPath)
    sessionStorage.setItem('musictitle', musicTitle)
    sessionStorage.setItem('musicimage', musicCover)
    sessionStorage.setItem('musicartist', musicArtist)
}
...
//     path: "./music/Eminem - Lose Yourself.mp3",
//   },
//   {
//     name: "Enthusiast",
//     artist: "Tours",
...
function playpauseTrack() {
  if (!isPlaying) {
    ...
    if (document.querySelectorAll('.playStop').length > 0)
      document.querySelectorAll('.playStop')[0].src= "/static/img/icon/play_btn.svg";
    if (document.querySelectorAll('.playpause-track').length > 0)
...
function playTrack() {
    curr_track.play();
    isPlaying = true;
    playpause_btn.innerHTML = '<img src="/static/img/icon/pause_pleer.svg"/>';
}

function pauseTrack() {
    curr_track.pause();
    isPlaying = false;
    playpause_btn.innerHTML = '<img src="/static/img/icon/play_pleer.svg"/>';
}
